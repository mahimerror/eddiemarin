...
import RegisterBanner from "@/assets/images/RegisterBanner.jpeg";
...
const Register = () => {
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex w-full flex-col gap-8 overflow-auto p-6 md:p-10 lg:p-20 lg:w-[55%]">
        <div className="space-y-2.5">
          <h1 className="text-5xl text-[#1D2635] font-semibold leading-[120%]">
            Sign Up
          </h1>
          <p className="text-lg font-mediul leading-[150%] text-[#6A7283]">
            You can sign up using your company .com account to access our
            services.
          </p>
        </div>
